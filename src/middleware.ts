...
export async function middleware(request: NextRequest) {
  ...
  script-src ${scriptSrcDirectives.join(' ')} https://plugin.handtalk.me https://cdn.equalweb.com https://access.equalweb.com https://cdn.pertoplugin.link https://pertocdn.pertoplugin.link;
