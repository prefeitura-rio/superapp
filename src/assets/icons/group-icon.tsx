...
export function GroupIcon(props: IconProps) {
  return (
    ...
    >
      <path
        d="M14.1654 17.5V15.8333C14.1654 14.9493 13.8142 14.1014 13.1891 13.4763C12.5639 12.8512 11.7161 12.5 10.832 12.5H4.16536C3.28131 12.5 2.43346 12.8512 1.80834 13.4763C1.18322 14.1014 0.832031 14.9493 0.832031 15.8333V17.5"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinecap="round"
      ...
      />
      <path
        d="M19.168 17.5001V15.8334C19.1674 15.0948 18.9216 14.3774 18.4691 13.7937C18.0166 13.2099 17.3831 12.793 16.668 12.6084"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinecap="round"
        strokeLinejoin="round"
