  ...
  return (
    <div className="relative w-full overflow-x-auto pb-4 no-scrollbar">
      <div className="flex gap-4 px-5 w-max">
        <div className="w-[85vw] max-w-[350px] h-[142px] bg-[#A0BFF9] rounded-lg overflow-hidden flex flex-col relative">
        ...
        <div className="w-[85vw] max-w-[350px] bg-[#B3DDE9] h-[142px] rounded-lg overflow-hidden flex flex-col relative">
