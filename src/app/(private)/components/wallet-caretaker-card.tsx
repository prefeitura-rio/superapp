...
export function WalletCaretakerCard({
  href,
  title,
  name,
  statusLabel,
      ...
      <div className="card__flip__container">
        <div className={`card${showDetails ? ' flipped' : ''}`} id="card">
          <div className="card-front">
            <div className="block w-full bg-wallet-3 rounded-3xl shadow-md text-white">
              <div className="p-6 justify-between flex flex-col">
                <div className="flex h-full min-h-[140px] flex-col justify-between">
                  ...
                  >
                    ...
                    {showEyeButton && (
                      <Button
                        className="rounded-full bg-wallet-3b size-10 hover:bg-wallet-3b hover:cursor-pointer"
