          ...
          <CardContent className="px-0">
            ...
            <div className="space-y-1 px-5">
              ...
              <div className="space-y-1 text-foreground">
                <p className="text-xs font-medium">Beatriz Camargo</p>
                <p className="text-xs font-medium">Luana Tavares Quintanilha</p>
                <p className="text-xs font-medium">Felipe Antunes Bastos</p>
              </div>
            </div>
