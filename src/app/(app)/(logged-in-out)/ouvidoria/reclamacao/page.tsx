    ...
    <div className="pt-20 pb-4 min-h-lvh max-w-xl mx-auto text-foreground flex flex-col">
      ...
      <div className="px-4 space-y-2">
        ...
        <Link
          ...
          className="block"
          href="https://www.1746.rio/hc/pt-br/articles/13791438677787-Cr%C3%ADtica"
        >
          <div className="bg-card rounded-2xl p-4 xl:p-6 hover:bg-card/50 transition-colors">
            <div className="grid grid-cols-[auto_1fr_auto] items-center gap-4">
              ...
              <div className="text-left">
                <h3 className="font-normal leading-5 text-sm text-foreground">
                  Primeira reclamação
                </h3>
        ...
        <Link
          ...
          rel="noopener noreferrer"
          className="block"
          href="https://www.1746.rio/hc/pt-br/articles/13790696897051-Reclama%C3%A7%C3%A3o"
        >
          <div className="bg-card rounded-2xl p-4 xl:p-6 hover:bg-card/50 transition-colors">
            <div className="grid grid-cols-[auto_1fr_auto] items-center gap-4">
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-muted-foreground">
                  Para acompanhar reclamações já feitas{' '}
                </p>
              </div>
              <div className="text-muted-foreground">
                <ChevronRightIcon />
