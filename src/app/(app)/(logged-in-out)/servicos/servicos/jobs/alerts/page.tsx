  ...
  const courseOptions = [
    {
      ...
      label: 'Empregos de Tecnologia',
      status: 'Ligado',
    },
    {
      key: 'construcao' as const,
      label: 'Empregos de Construção Civil',
      status: 'Ligado',
    },
    {
    ...
    },
    {
      ...
      label: 'Empregos de Marcenaria',
      status: 'Desligado',
    },
    { key: 'costura' as const, label: 'Empregos de Costura', status: 'Ligado' },
  ]
  return (
