    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-baseline gap-2">
        <input
          ...
          style={{ fontSize: '3rem', lineHeight: '1', height: 'auto', width: `${Math.max(displayValue.length, 1)}ch` }}
          aria-label="Duração em dias"
        />
        <span className="font-medium text-primary" style={{ fontSize: '3rem', lineHeight: '1' }}>dias</span>
      </div>
    </div>
  )
}
