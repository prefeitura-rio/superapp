...
import type { UserInfoComplete } from '../confirmar-informacoes/types'
...
export default async function AtualizarDadosPage({ searchParams }: PageProps) {
  ...
  let userInfoObj: Partial<UserInfoComplete> = userAuthInfo
  ...
  const formatedUserPhone =
    userInfoObj && 'telefone' in userInfoObj
      ? (formatUserPhone(
          userInfoObj.telefone as ModelsTelefone | undefined
        ) as UserInfoComplete['telefone'])
