...
import { isPdfName } from '@/lib/cadmicro/file-utils'
import type { VehicleDocument } from '@/lib/cadmicro/types'
...
export function VerifiedDocumentSection({
  ...
  const { url: previewUrl, isLoading: isLoadingPreview } = useCadmicroSignedUrl(
