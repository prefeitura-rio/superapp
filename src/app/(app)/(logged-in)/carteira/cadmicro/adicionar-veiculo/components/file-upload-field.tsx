...
import { DocumentFileCard } from '@/app/components/cadmicro/document-file-card'
import { PdfPreviewDialog } from '@/app/components/cadmicro/pdf-preview-dialog'
...
import { formatFileSizeLabel, isPdfName } from '@/lib/cadmicro/file-utils'
import {
  CadmicroUploadError,
  uploadCadmicroFile,
  validateCadmicroFile,
} from '@/lib/cadmicro/upload-file'
...
export function FileUploadField({
  ...
  const { url: signedPreviewUrl } = useCadmicroSignedUrl(
    isPdf ? null : fileUrl,
    {
  ...
  const uploadFile = async (file: File) => {
    ...
    try {
      const result = await uploadCadmicroFile(file, kind)
      ...
      setHasError(true)
      const message =
        err instanceof CadmicroUploadError
          ? err.message
