...
import {
  useCadmicroVehicleBrands,
  useCadmicroVehicleColors,
  useCadmicroVehicleModels,
} from '@/hooks/cadmicro/use-cadmicro-catalog'
...
export function VehicleInfoFields<T extends VehicleInfoFormValues>({
  ...
  } = useCadmicroVehicleModels(brandId || null)
  const {
    data: colorsData,
  ...
  useCadmicroQueryErrorToast(
    ...
    'cadmicro-catalog-brands-error'
  )
  useCadmicroQueryErrorToast(
    isModelsError,
    'Não foi possível carregar os modelos',
    'cadmicro-catalog-models-error'
  )
  useCadmicroQueryErrorToast(
    isColorsError,
    'Não foi possível carregar as cores',
    'cadmicro-catalog-colors-error'
  )
