...
export type getAvatarsResponseComposite = getAvatarsResponse200 | getAvatarsResponse400 | getAvatarsResponse429 | getAvatarsResponse500;
...
export const getGetAvatarsUrl = (params?: GetAvatarsParams,) => {
  ...
  return stringifiedParams.length > 0 ? `/avatars?${stringifiedParams}` : `/avatars`
}

export const getAvatars = async (params?: GetAvatarsParams, options?: RequestInit): Promise<getAvatarsResponse> => {
...
export type postAvatarsResponseComposite = postAvatarsResponse201 | postAvatarsResponse400 | postAvatarsResponse401 | postAvatarsResponse403 | postAvatarsResponse429 | postAvatarsResponse500;
...
export const postAvatars = async (modelsAvatarRequest: ModelsAvatarRequest, options?: RequestInit): Promise<postAvatarsResponse> => {
...
export type deleteAvatarsIdResponseComposite = deleteAvatarsIdResponse204 | deleteAvatarsIdResponse400 | deleteAvatarsIdResponse401 | deleteAvatarsIdResponse403 | deleteAvatarsIdResponse404 | deleteAvatarsIdResponse429 | deleteAvatarsIdResponse500;
...
export const deleteAvatarsId = async (id: string, options?: RequestInit): Promise<deleteAvatarsIdResponse> => {
...
export type getCitizenCpfAvatarResponseComposite = getCitizenCpfAvatarResponse200 | getCitizenCpfAvatarResponse400 | getCitizenCpfAvatarResponse401 | getCitizenCpfAvatarResponse403 | getCitizenCpfAvatarResponse404 | getCitizenCpfAvatarResponse429 | getCitizenCpfAvatarResponse500;
    
export type getCitizenCpfAvatarResponse = getCitizenCpfAvatarResponseComposite & {
  headers: Headers;
}
...
export const getCitizenCpfAvatar = async (cpf: string, options?: RequestInit): Promise<getCitizenCpfAvatarResponse> => {
  
  return customFetch<getCitizenCpfAvatarResponse>(getGetCitizenCpfAvatarUrl(cpf),
  {      
    ...options,
    method: 'GET'
...
export type putCitizenCpfAvatarResponseComposite = putCitizenCpfAvatarResponse200 | putCitizenCpfAvatarResponse400 | putCitizenCpfAvatarResponse401 | putCitizenCpfAvatarResponse403 | putCitizenCpfAvatarResponse404 | putCitizenCpfAvatarResponse422 | putCitizenCpfAvatarResponse429 | putCitizenCpfAvatarResponse500;
    
export type putCitizenCpfAvatarResponse = putCitizenCpfAvatarResponseComposite & {
  headers: Headers;
}
...
export const putCitizenCpfAvatar = async (cpf: string,
    modelsUserAvatarRequest: ModelsUserAvatarRequest, options?: RequestInit): Promise<putCitizenCpfAvatarResponse> => {
  
  return customFetch<putCitizenCpfAvatarResponse>(getPutCitizenCpfAvatarUrl(cpf),
  {      
    ...options,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
