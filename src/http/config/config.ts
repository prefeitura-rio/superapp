...
export const getConfigChannels = async ( options?: RequestInit): Promise<getConfigChannelsResponse> => {
...
export type getConfigOptOutReasonsResponseComposite = getConfigOptOutReasonsResponse200;
    
export type getConfigOptOutReasonsResponse = getConfigOptOutReasonsResponseComposite & {
  headers: Headers;
}
...
export const getConfigOptOutReasons = async ( options?: RequestInit): Promise<getConfigOptOutReasonsResponse> => {
  
  return customFetch<getConfigOptOutReasonsResponse>(getGetConfigOptOutReasonsUrl(),
  {      
    ...options,
    method: 'GET'
