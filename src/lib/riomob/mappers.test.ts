...
import { isOtherBrand, isOtherModel } from '@/lib/riomob/catalog-constants'
import { isImageAsset, isPdfName } from '@/lib/riomob/file-utils'
import {
  formatFileSizeLabel,
...
describe('createVehiclePayloadSchema', () => {
  const base = {
    ...
    serial_number_photo_url:
      'https://storage.googleapis.com/bucket/riomob/1/serial/a.png',
    vehicle_photo_url:
      'https://storage.googleapis.com/bucket/riomob/1/vehicle/b.png',
    has_invoice: false,
