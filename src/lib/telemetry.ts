...
/**
 * Trace a Server Component rendering
 * Use this at the top of Server Components to track rendering performance
 *
 * @param componentName - The name of the component
 * @param fn - The async function to execute (component rendering logic)
 * @param attributes - Optional attributes to include as span attributes
 * @returns The result of the component rendering
 *
 * @example
 * export default async function HomePage() {
 *   return traceServerComponent('HomePage', async () => {
