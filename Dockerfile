...
# Prevent lefthook install during image build — git is not available in alpine
ENV LEFTHOOK=0
...
ARG NEXT_PUBLIC_BASE_API_URL_APP_CATALOGO
...
ENV NEXT_PUBLIC_BASE_API_URL_APP_CATALOGO=$NEXT_PUBLIC_BASE_API_URL_APP_CATALOGO
