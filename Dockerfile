...
ARG NEXT_PUBLIC_API_BUSCA_ROOT_URL
ARG NEXT_PUBLIC_BASE_API_URL
ARG IDENTIDADE_CARIOCA_CLIENT_SECRET
...
ENV NEXT_PUBLIC_API_BUSCA_ROOT_URL=$NEXT_PUBLIC_API_BUSCA_ROOT_URL
ENV NEXT_PUBLIC_BASE_API_URL=$NEXT_PUBLIC_BASE_API_URL
ENV IDENTIDADE_CARIOCA_CLIENT_SECRET=$IDENTIDADE_CARIOCA_CLIENT_SECRET
